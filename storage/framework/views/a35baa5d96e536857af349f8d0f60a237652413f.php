          ...
          <div class="box">
            <div class="box-header">
				<div class="pull-right">
					<a class="btn btn-success" href="<?php echo e(route('admin.parents.create')); ?>">Add New</a>
				</div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<tr>
						...
						<td>
							<!--<a class="btn btn-info" href="<?php echo e(route('admin.parents.show',$parent->id)); ?>">Show</a>-->
							<a class="btn btn-primary" href="<?php echo e(route('admin.parents.edit',$parent->id)); ?>">Edit</a>
							<?php echo Form::open(['method' => 'DELETE','route' => ['admin.parents.destroy', $parent->get_parent->pa_user_id],'style'=>'display:inline','onsubmit' => 'return ConfirmDelete()']); ?>
