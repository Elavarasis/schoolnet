        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="<?php echo e(URL::to('/')); ?>/public/images/tenant/<?php echo e($user->image); ?>" alt="Profile picture" width="100px;">
				...
				<?php endif; ?>
				  ...
				  <div class="box-body">
					...
					<div class="form-group">
					  ...
					  <?php echo Form::select('schl_state_id', $school_states, null, array('class' => 'form-control', 'id' => 'state_id')); ?>

					</div>
					
					<div class="form-group">
					  <label for="exampleInputEmail1">City</label>
					  <?php echo Form::select('schl_city_id', $school_cities, null, array('class' => 'form-control', 'id' => 'city_id')); ?>
					...
					<div class="form-group">
					  ...
					  <?php echo Form::text('schl_classes', null, array('placeholder' => 'School Level','class' => 'form-control')); ?>
					...
					<div class="form-group">
					  ...
					  <?php echo Form::text('schl_attendance_markers', null, array('placeholder' => 'School Level','class' => 'form-control')); ?>
              ...
              <div class="tab-pane" id="editprofile">
				...
				<?php echo Form::model($user, ['files'=> true, 'method' => 'post', 'url' => "tenant/home/save_profile/"]); ?>
				  ...
				  <div class="box-body">
					...
					<div class="form-group">
					  <label for="exampleInputEmail1">State</label>
					  <?php echo Form::select('state_id', $user_states, null, array('class' => 'form-control', 'id' => 'state_id_2')); ?>

					</div>
					
					<div class="form-group">
					  <label for="exampleInputEmail1">City</label>
					  <?php echo Form::select('city', $user_cities, null, array('class' => 'form-control', 'id' => 'city_id_2')); ?>
					...
					<div class="form-group">
					  ...
					  <?php if(isset($user)): ?>
						<img width="100px" src="<?php echo e(URL::to('/')); ?>/public/images/tenant/<?php echo e($user->image); ?>" alt="" />
					  <?php endif; ?>
