          ...
          <div class="box">
            <div class="box-header">
				<div class="pull-right">
					<a class="btn btn-success" href="<?php echo e(route('admin.students.create')); ?>">Add New</a>
				</div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<tr>
						...
						<td>
							<!--<a class="btn btn-info" href="<?php echo e(route('admin.students.show',$student->id)); ?>">Show</a>-->
							<a class="btn btn-primary" href="<?php echo e(route('admin.students.edit',$student->id)); ?>">Edit</a>
							<?php echo Form::open(['method' => 'DELETE','route' => ['admin.students.destroy', $student->get_student->st_user_id],'style'=>'display:inline','onsubmit' => 'return ConfirmDelete()']); ?>
