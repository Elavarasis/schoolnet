          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				<div class="pull-right">
					<a class="btn-sm btn-primary" href="<?php echo e(route('tenant.attendances.index')); ?>"> Back</a>
				</div>
				<h3 class="box-title">
            ...
            <!-- form start -->
			<?php echo Form::open(array('files'=> true, 'url' => 'tenant/attendances/import_now/', 'method' => 'post')); ?>
