          ...
          <div class="box">
            <div class="box-header">
				<div class="pull-right">
					<a class="btn btn-success" href="<?php echo e(route('tenant.events.create')); ?>">Add New</a>
				</div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-primary" href="<?php echo e(route('tenant.events.edit',$event->id)); ?>">Edit</a>
							<?php echo Form::open(['method' => 'DELETE','route' => ['tenant.events.destroy', $event->id],'style'=>'display:inline','onsubmit' => 'return ConfirmDelete()']); ?>
