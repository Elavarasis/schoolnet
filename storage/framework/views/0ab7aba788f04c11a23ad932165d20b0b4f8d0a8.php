          ...
          <div class="box">
            <div class="box-header">
				<div class="pull-right">
					<a class="btn btn-success" href="<?php echo e(route('tenant.normal_users.create')); ?>">Add New</a>
				</div>
			...
			<?php endif; ?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<?php if($normal_user->get_normal_user->nu_created_by == Auth::user()->id): ?>
					<tr>
						<td><?php echo e(++$i); ?></td>
						...
						<td>
							<!--<a class="btn btn-info" href="<?php echo e(route('tenant.normal_users.show',$normal_user->id)); ?>">Show</a>-->
							<a class="btn btn-primary" href="<?php echo e(route('tenant.normal_users.edit',$normal_user->id)); ?>">Edit</a>
							<?php echo Form::open(['method' => 'DELETE','route' => ['tenant.normal_users.destroy', $normal_user->get_normal_user->nu_user_id],'style'=>'display:inline','onsubmit' => 'return ConfirmDelete()']); ?>
