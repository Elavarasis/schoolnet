			...
			<?php endif; ?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<tr>
						<td><?php echo e(++$i); ?></td>
						<td><img width="50px" src="<?php echo e(URL::to('/')); ?>/public/images/option/<?php echo e($payment->opt_image); ?>" alt="" /></td>
						<td><?php echo e($payment->opt_text); ?></td>
						<td>
							<?php if($payment->opt_status == 1): ?>
						...
						<td>
							<a class="btn btn-primary" href="<?php echo e(route('admin.payments.edit',$payment->id)); ?>">Edit</a>
						</td>
					</tr>
					<?php endforeach; ?>
                </tbody>
