      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <?php if(isset($course)): ?>
				<?php echo Form::model($course, ['files'=> true, 'method' => 'PATCH','route' => ['admin.courses.update', $course->id]]); ?>

			<?php else: ?>
				<?php echo Form::open(array('files'=> true, 'route' => 'admin.courses.store','method'=>'POST')); ?>
			...
			<?php endif; ?>
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <?php echo Form::select('course_school_id', $schools, null, array('class' => 'form-control', 'id' => 'school_id')); ?>
