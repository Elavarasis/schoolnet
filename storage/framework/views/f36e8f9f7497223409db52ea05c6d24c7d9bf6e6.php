          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				<div class="pull-right">
					<a class="btn-sm btn-primary" href="<?php echo e(route('admin.normal_users.index')); ?>"> Back</a>
				</div>
				<h3 class="box-title">
            ...
            <!-- form start -->
            <?php if(isset($normal_user)): ?>
				<?php echo Form::model($normal_user, ['files'=> true, 'method' => 'PATCH','route' => ['admin.normal_users.update', $normal_user->id]]); ?>

			
				<?php /**/ $normal_user->dob = date("d/m/Y", strtotime($normal_user->dob) ) /**/ ?> <!-- change date format of DOB to d/m/Y -->
			<?php else: ?>
				<?php echo Form::open(array('files'=> true, 'route' => 'admin.normal_users.store','method'=>'POST')); ?>
