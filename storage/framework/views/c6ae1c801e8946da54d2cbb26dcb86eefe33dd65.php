          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				<div class="pull-right">
					<a class="btn-sm btn-primary" href="<?php echo e(route('admin.teachers.index')); ?>"> Back</a>
				</div>
				<h3 class="box-title">
            ...
            <!-- form start -->
            <?php if(isset($teacher)): ?>
				<?php echo Form::model($teacher, ['files'=> true, 'method' => 'PATCH','route' => ['admin.teachers.update', $teacher->id]]); ?>

			
				<?php /**/ $teacher->dob = date("d/m/Y", strtotime($teacher->dob) ) /**/ ?> <!-- change date format of DOB to d/m/Y -->
			<?php else: ?>
				<?php echo Form::open(array('files'=> true, 'route' => 'admin.teachers.store','method'=>'POST')); ?>
