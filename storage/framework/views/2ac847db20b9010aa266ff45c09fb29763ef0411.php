        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
			...
			<?php if(isset(Auth::user()->image)): ?>
				<img src="<?php echo e(URL::to('/')); ?>/public/images/tenant/<?php echo e(Auth::user()->image); ?>" class="user-image" alt="User Image">
			<?php else: ?>
              <img src="<?php echo e(url('/public/images/user.png')); ?>" class="user-image" alt="User Image">
            <?php endif; ?>
			  <span class="hidden-xs"><?php echo e(ucfirst(Auth::user()->first_name)); ?> <?php echo e(ucfirst(Auth::user()->last_name)); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
				<?php if(isset(Auth::user()->image)): ?>
					<img src="<?php echo e(URL::to('/')); ?>/public/images/tenant/<?php echo e(Auth::user()->image); ?>" class="img-circle" alt="User Image">
				<?php else: ?>
				  <img src="<?php echo e(url('/public/images/user.png')); ?>" class="user-image" alt="User Image">
				<?php endif; ?>                <p>
