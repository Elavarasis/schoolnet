          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				<div class="pull-right">
					<a class="btn-sm btn-primary" href="<?php echo e(route('tenant.students.index')); ?>"> Back</a>
				</div>
				<h3 class="box-title">
            ...
            <!-- form start -->
            <?php if(isset($student)): ?>
				<?php echo Form::model($student, ['files'=> true, 'method' => 'PATCH','route' => ['tenant.students.update', $student->id]]); ?>

			
				<?php /**/ $student->dob = date("d/m/Y", strtotime($student->dob) ) /**/ ?> <!-- change date format of DOB to d/m/Y -->
			<?php else: ?>
				<?php echo Form::open(array('files'=> true, 'route' => 'tenant.students.store','method'=>'POST')); ?>
