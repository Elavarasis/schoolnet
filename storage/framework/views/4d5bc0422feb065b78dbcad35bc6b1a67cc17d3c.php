          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				<div class="pull-right">
					<a class="btn-sm btn-primary" href="<?php echo e(route('tenant.events.index')); ?>"> Back</a>
				</div>
				<h3 class="box-title">
					<?php if(isset($event)): ?>
						Edit Event
            ...
            <!-- form start -->
            <?php if(isset($event)): ?>
				<?php echo Form::model($event, ['files'=> true, 'method' => 'PATCH','route' => ['tenant.events.update', $event->id]]); ?>
			...
			<?php else: ?>
				<?php echo Form::open(array('files'=> true, 'route' => 'tenant.events.store','method'=>'POST')); ?>
