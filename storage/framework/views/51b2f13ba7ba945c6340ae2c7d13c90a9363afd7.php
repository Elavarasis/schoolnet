        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <?php if(isset($student)): ?>
				...
				<?php /**/ $student->st_dob = date("d/m/Y", strtotime($student->st_dob) ) /**/ ?> <!-- change date format of DOB to d/m/Y -->
			<?php else: ?>
			...
			<?php endif; ?>
              <div class="box-body">
				...
				<div class="form-group">
				  ...
				  <?php echo Form::textarea('st_address',null,['placeholder' => 'Adress','class'=>'form-control', 'rows' => 3]); ?>

                </div>
				
				<div class="form-group">
                  <label for=" ">City</label>
                  <?php echo Form::text('st_city', null, array('placeholder' => 'City','class' => 'form-control')); ?>

                </div>
				
				<div class="form-group">
                  <label for="exampleInputEmail1">Country</label>
                  <?php echo Form::select('st_country_id', $countries, null, array('class' => 'form-control', 'id' => 'country_id')); ?>

                </div>
				
				<div class="form-group">
                  <label for="exampleInputEmail1">State</label>
                  <?php echo Form::select('st_state_id', $states, null, array('class' => 'form-control', 'id' => 'state_id')); ?>

                </div>
				
				<div class="form-group">
                  <label for=" ">Date of Birth</label>
                  <?php echo Form::text('st_dob', null, array('placeholder' => 'Date of Birth','class' => 'form-control dob')); ?>
				...
				<div class="form-group">
				  ...
				  <?php if(isset($student)): ?>
					<img width="100px" src="<?php echo e(URL::to('/')); ?>/public/images/student/<?php echo e($student->st_image); ?>" alt="" />
				  <?php endif; ?>
