          ...
          <div class="box">
            <div class="box-header">
				<div class="pull-right">
					<a class="btn btn-success" href="<?php echo e(route('admin.categories.create')); ?>">Add New</a>
				</div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<tr>
						...
						<td><?php echo e($category->cat_slug); ?></td>
						<td><?php echo e($category->parent_name); ?></td>
						<td>
							<?php if(isset($category->cat_image)): ?>
								<img width="50px" src="<?php echo e(URL::to('/')); ?>/public/images/category/small--<?php echo e($category->cat_image); ?>" alt="" />
							<?php endif; ?>
						</td>
						<td>
						...
						<td>
							...
							<?php echo Form::open(['method' => 'DELETE','route' => ['admin.categories.destroy', $category->id],'style'=>'display:inline','onsubmit' => 'return ConfirmDelete()']); ?>
