          ...
          <div class="box">
            <div class="box-header">
				<div class="pull-right">
					<a class="btn btn-success" href="<?php echo e(route('stud.leaves.create')); ?>">Apply Leave</a>
				</div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<tr>
						...
						<td><?php echo e($leave->user->first_name); ?> <?php echo e($leave->user->last_name); ?></td>
						...
						<td>
							<a class="btn btn-info" href="<?php echo e(route('stud.leaves.show',$leave->id)); ?>">Show</a>
							
							<?php if($leave->lv_status == 0): ?>
								<a class="btn btn-primary" href="<?php echo e(route('stud.leaves.edit',$leave->id)); ?>">Edit</a>
							<?php endif; ?>
							
							<?php echo Form::open(['method' => 'DELETE','route' => ['stud.leaves.destroy', $leave->id],'style'=>'display:inline','onsubmit' => 'return ConfirmDelete()']); ?>
