...
<head>
  ...
  <title>School Network | Dashboard</title>
  ...
  <!-- Daterange picker -->
  <?php echo Html::style('assets/admin/plugins/daterangepicker/daterangepicker.css'); ?>
...
<?php echo Html::script('assets/admin/dist/js/pages/dashboard.js');; ?>
