...
class Normal_users extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		return view('admin.normal_users.index',compact('normal_users'));
    }
    ...
    public function store(Normal_User_Request $request)
    {
		...
		if($user_id){
			...
			DB::commit();	
			return redirect()->route('admin.normal_users.index')->with('success','Normal user added successfully');
		}
    ...
    public function show($id)
    {
        ...
        $normal_user = DB::table('users')
				...
				->where('users.id', $id)
				->first();
        return view('admin.normal_userss.show',compact('normal_user'));
    ...
    public function update(Normal_User_Request $request, $id)
    {
		...
		return redirect()->route('admin.normal_users.index')->with('success','Normal user updated successfully');
    ...
    {	
        ...
        return redirect()->route('admin.normal_users.index')
