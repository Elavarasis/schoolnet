...
class Teachers extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		return view('tenant.teachers.index',compact('teachers','school_id'));
    }
    ...
    public function create()
    {
		...
		return view('tenant.teachers.addedit',compact('countries','states','cities','schools'));
    }
    ...
    public function store(Teacher_Request $request)
    {
		...
		if($user_id){
			...
			return redirect()->route('tenant.teachers.index')->with('success','Teacher added successfully');
		}
    ...
    public function edit($id)
    {
		...
		return view('tenant.teachers.addedit',compact('teacher','countries','states','cities','schools'));
    }
    ...
    public function update(Teacher_Request $request, $id)
    {
		...
		return redirect()->route('tenant.teachers.index')->with('success','Teacher updated successfully');
