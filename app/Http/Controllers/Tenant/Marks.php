...
class Marks extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		return view('tenant.marks.index',compact('students','divisions','marks','data','exam_names'));
	...
	public function export(Request $request)
    {
		...
		return view('tenant.marks.export',compact('marks'));
    }	
	
	/* import */
	public function import()
	{
		return view('tenant.marks.import');
	}
			...
			if(!empty($data) && $data->count()){
				...
				foreach ($data as $key => $value) {
					foreach ($value as $row)
					{
							...
							//check tenant has permission to add marks for this student
				...
				if(!empty($insert)){
					...
					return redirect('tenant/marks/import')->with('success','Imported successfully');
				} else {	
					return redirect('tenant/marks/import')->with('error','Something went wrong, this data may be already added');
				}
			}
		}
