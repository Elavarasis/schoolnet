              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-info" href="{{ route('tenant.leaves.show',$leave->id) }}">Show</a>
							
							{!! Form::open(['method' => 'DELETE','route' => ['tenant.leaves.destroy', $leave->id],'style'=>'display:inline','onsubmit' => 'return ConfirmDelete()']) !!}
