          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				<div class="pull-right">
					<a class="btn-sm btn-primary" href="{{ route('tenant.teachers.index') }}"> Back</a>
				</div>
				<h3 class="box-title">
					@if(isset($teacher))
						Edit Teacher
            ...
            <!-- form start -->
            @if(isset($teacher))
				{!! Form::model($teacher, ['files'=> true, 'method' => 'PATCH','route' => ['tenant.teachers.update', $teacher->id]]) !!}
			
				{{--*/ $teacher->dob = date("d/m/Y", strtotime($teacher->dob) ) /*--}} <!-- change date format of DOB to d/m/Y -->
			@else
				{!! Form::open(array('files'=> true, 'route' => 'tenant.teachers.store','method'=>'POST')) !!}
			@endif
              <div class="box-body">
