          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				<div class="pull-right">
					<a class="btn-sm btn-primary" href="{{ route('tenant.marks.index') }}"> Back</a>
				</div>
				<h3 class="box-title">
            ...
            <!-- form start -->
			{!! Form::open(array('files'=> true, 'url' => 'tenant/marks/import_now/', 'method' => 'post')) !!}
              <div class="box-body">
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
						  <label for=" ">Exam Name</label>
						  {!! Form::text('exam_name', null, array('placeholder' => 'Name of the Exam','class' => 'form-control')) !!}
						</div>
					</div>
