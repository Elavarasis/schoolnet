        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
				...
				<div class="filter">
					{!! Form::open(array('files'=> true, 'url' => 'tenant/marks/search', 'method' => 'get')) !!}
						<?php
						...
						<div class="form-group col-md-1">
							<a class="btn btn-primary" href="{{ url('tenant/marks/export') }}?<?= $_SERVER['QUERY_STRING'] ?>" style="margin-top:24px;">Export</a>
						</div>
