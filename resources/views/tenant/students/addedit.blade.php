          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				<div class="pull-right">
					<a class="btn-sm btn-primary" href="{{ route('tenant.students.index') }}"> Back</a>
				</div>
				<h3 class="box-title">
					@if(isset($student))
						Edit Student
            ...
            <!-- form start -->
            @if(isset($student))
				{!! Form::model($student, ['files'=> true, 'method' => 'PATCH','route' => ['tenant.students.update', $student->id]]) !!}
			
				{{--*/ $student->dob = date("d/m/Y", strtotime($student->dob) ) /*--}} <!-- change date format of DOB to d/m/Y -->
			@else
				{!! Form::open(array('files'=> true, 'route' => 'tenant.students.store','method'=>'POST')) !!}
			@endif
              <div class="box-body">
