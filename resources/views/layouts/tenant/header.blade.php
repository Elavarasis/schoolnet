        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
			...
			@if(isset(Auth::user()->image))
				<img src="{{ URL::to('/') }}/public/images/tenant/{{Auth::user()->image}}" class="user-image" alt="User Image">
			@else
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
				@if(isset(Auth::user()->image))
					<img src="{{ URL::to('/') }}/public/images/tenant/{{Auth::user()->image}}" class="img-circle" alt="User Image">
				@else
				  <img src="{{ url('/public/images/user.png') }}" class="user-image" alt="User Image">
				@endif                <p>
