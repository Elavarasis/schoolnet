          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				<div class="pull-right">
					<a class="btn-sm btn-primary" href="{{ route('admin.events.index') }}"> Back</a>
				</div>
				<h3 class="box-title">
					@if(isset($event))
						Edit Event
            ...
            <!-- form start -->
            @if(isset($event))
				{!! Form::model($event, ['files'=> true, 'method' => 'PATCH','route' => ['admin.events.update', $event->id]]) !!}
			...
			@else
				{!! Form::open(array('files'=> true, 'route' => 'admin.events.store','method'=>'POST')) !!}
			@endif
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  {!! Form::select('event_school_id', $schools, null, array('class' => 'form-control', 'id' => 'school_id')) !!}
                </div>
