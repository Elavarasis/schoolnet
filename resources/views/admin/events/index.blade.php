          ...
          <div class="box">
            <div class="box-header">
				<div class="pull-right">
					<a class="btn btn-success" href="{{ route('admin.events.create') }}">Add New</a>
				</div>
                ...
                <tbody>
					...
					<tr>
						...
						<td>
							...
							{!! Form::open(['method' => 'DELETE','route' => ['admin.events.destroy', $event->id],'style'=>'display:inline','onsubmit' => 'return ConfirmDelete()']) !!}
